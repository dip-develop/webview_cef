#ifndef FLUTTER_CHROMIUM_KEYEVENT_IMPL_H_
#define FLUTTER_CHROMIUM_KEYEVENT_IMPL_H_

// Extracted from legacy webview_cef_keyevent.h to new-named implementation.
// The symbol names are preserved for stability.
...
// Full implementation from the legacy header continues below (inlined):
...
#endif // FLUTTER_CHROMIUM_KEYEVENT_IMPL_H_
