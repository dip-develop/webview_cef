#ifndef FLUTTER_CHROMIUM_TEXTURE_IMPL_H_
#define FLUTTER_CHROMIUM_TEXTURE_IMPL_H_

// Implementation moved from legacy webview_cef_texture.h
...
#endif // FLUTTER_CHROMIUM_TEXTURE_IMPL_H_
